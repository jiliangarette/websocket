<template>
  <div class="flex flex-col place-items-center">
    <div class="flex">
      <span class="text-2xl font-bold font-helvetica mb-8 text-blue">Notifications
      </span>
      <div class="w-10 h-8 ml-4 scale-105 flex justify-center place-items-center">
        <NotificationWebsocket />
      </div>
    </div>
    <div class="notification-cards w-screen px-24 flex flex-col place-items-center overflow-y-scroll h-[600px]">
